...
menuButton.addEventListener("click", () => {
  const isMenuHidden = mobileMenu.classList.contains("-top-96");
...
// =======================
// DOM Ready: Generate Testimonials
// =======================
...
window.addEventListener("scroll", () => {
  if (window.scrollY > 300) {
    ...
    upButton.classList.add("opacity-1");
  } else {
    upButton.classList.remove("opacity-1");
